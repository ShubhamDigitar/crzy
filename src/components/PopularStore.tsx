...
const PopularStore = () => {
  ...
  return (
    <div className="w-full bg-white px-4 py-6 md:px-8">
      <h2 className="text-2xl font-bold mb-6 text-gray-800">Popular Stores</h2>
      ...
      <div className="flex flex-col lg:flex-row px-4 gap-6">
        ...
        <div className="hidden lg:block lg:w-1/4 my-2 rounded-lg h-[25em] bg-gradient-to-br from-gray-800 to-gray-600">
          ...
          <p className="text-white font-bold text-3xl px-4 capitalize">store of the month</p>
          <div className="w-[70%] h-[8em] rounded-r-2xl mt-24 bg-black">
            {/* Featured store image will go here */}
            <div className="text-white flex items-center justify-start pt-10 pl-4 text-3xl  ">Myntra</div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-3/4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
            {dummyStores.map((store) => (
              ...
              >
                <motion.div 
                  className="relative w-64 h-24 rounded-lg shadow-lg border-2 border-gray-200 overflow-hidden bg-white"
                  whileHover={{ 
                    borderColor: "#9CA3AF",
