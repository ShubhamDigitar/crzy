  ...
  return (
    <div className="w-full px-8 flex h-[30em] gap-4 ">
      <div className="section1 w-2/3">
        <div className="w-full h-full flex flex-row items-start justify-start bg-white text-foreground dark:text-muted font-normal overflow-hidden lg:p-16 lg:pt-48">
